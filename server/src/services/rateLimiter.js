...
const WINDOW_MINUTES = parseInt(process.env.RATE_LIMIT_WINDOW_MINUTES, 10) || 10;
const WINDOW_MAX = parseInt(process.env.RATE_LIMIT_MAX_REQUESTS, 10) || 3;
const DAILY_MAX = parseInt(process.env.RATE_LIMIT_DAILY_MAX, 10) || 20;
